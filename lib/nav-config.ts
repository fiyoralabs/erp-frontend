...
export const navItems: NavItem[] = [
  ...
  { title: "Inventory", href: "/inventory", icon: Boxes, implemented: true, requiredPermissions: ["INVENTORY_VIEW"] },
  { title: "Purchases", href: "/purchases", icon: ShoppingCart, implemented: true, requiredPermissions: ["PURCHASE_VIEW"] },
  { title: "Sales", href: "/sales", icon: TrendingUp, implemented: true, requiredPermissions: ["SALES_VIEW"] },
  {
    title: "CRM",
    href: "/crm",
    icon: Users,
  ...
  { title: "Finance", href: "/finance", icon: CircleDollarSign, implemented: true, requiredPermissions: ["FINANCE_VIEW"] },
  ...
  { title: "Audit Log", href: "/audit", icon: History, implemented: true, requiredPermissions: ["AUDIT_VIEW"] },
